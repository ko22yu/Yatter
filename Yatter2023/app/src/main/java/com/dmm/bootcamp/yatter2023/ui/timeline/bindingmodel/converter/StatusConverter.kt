...
import com.dmm.bootcamp.yatter2023.ui.timeline.bindingmodel.converter.MediaConverter.convertToDomainModel
...
object StatusConverter {
    ...
    fun convertToBindingModel(status: Status): StatusBindingModel =
        StatusBindingModel(
            ...
            attachmentMediaList = convertToDomainModel(status.attachmentMediaList)
        )
}